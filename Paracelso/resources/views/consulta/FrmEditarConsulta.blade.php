				...
				{{-- <div class="row"> --}}
					<div class="form-group col-sm-3 col-md-3">
				    	<div class="input-group">
							...
							{!! Form::number('id_consultorio',$consulta->id_consulta,['id'=>'id_consultorio','class'=>'form-control','placeholder'=>'Numero de consultorio']) !!}
						</div>
					</div>
					<div class="form-group col-sm-3 col-md-3">
						<div class="input-group">
							<span class="input-group-addon">Tipo</span>
							{!! Form::select('tipo_consulta',$tipoConsulta,$consulta->tipo_consulta,['id'=>'tipo_consulta','class'=>'form-control']) !!}
						</div>
					</div>
					<div class="form-group col-sm-6 col-md-6">
						<label for="">Medico Responsable Registrado:</label>
						<label for="">{{ $consulta->medico->personas->nombre }} {{ $consulta->medico->personas->ap_paterno }}</label>
						<div class="input-group">
				...
				{{-- <div class="row"> --}}
					...
					<div class="form-group col-sm-7 col-md-7">
				    	<div class="input-group">
							...
							{!! Form::text('historia',$consulta->historia,['id'=>'historia','class'=>'form-control','placeholder'=>'Enfermedad Actual','onkeyup'=>'mayuscula(historia)']) !!}
						</div>
					</div>
					...
					<div class="form-group">
						{!! Form::hidden('id_consulta',$consulta->id_consulta,['id'=>'id_consulta','class'=>'form-control','placeholder'=>'idh']) !!}
					</div>
				{{-- </div> --}}
			{!! Form::close() !!}
		</div>
					...
					{!! Form::open(['id'=>'formRevision']) !!}
						<div class="form-group col-sm-10 col-md-10">
					    	<div class="input-group">
								...
								{!! Form::text('revision_general',$revision->revision_general,['id'=>'revision_general','class'=>'form-control','placeholder'=>'Revision fisica general','onkeyup'=>'mayuscula(revision_general)']) !!}
							</div>
						</div>
						...
						<div class="row container-fluid" id="EFS">
							<div class="form-group col-sm-3 col-md-3">
								...
								{!! Form::text('cabeza_cuello',$revision->cabeza_cuello,['id'=>'cabeza_cuello','class'=>'form-control','placeholder'=>'Cabeza y cuello','onkeyup'=>'mayuscula(cabeza_cuello)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					            {{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('torax',$revision->torax,['id'=>'torax','class'=>'form-control','placeholder'=>'Torax','onkeyup'=>'mayuscula(torax)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					           	{{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('miembros_superiores',$revision->miembros_superiores,['id'=>'miembros_superiores','class'=>'form-control','placeholder'=>'M. superiores','onkeyup'=>'mayuscula(miembros_superiores)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					            {{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('abdomen',$revision->abdomen,['id'=>'abdomen','class'=>'form-control','placeholder'=>'Abdomen','onkeyup'=>'mayuscula(abdomen)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					            {{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('genital_urinario',$revision->genital_urinario,['id'=>'genital_urinario','class'=>'form-control','placeholder'=>'Genitourinario','onkeyup'=>'mayuscula(genital_urinario)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					            {{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('miembros_inferiores',$revision->miembros_inferiores,['id'=>'miembros_inferiores','class'=>'form-control','placeholder'=>'M. Inferiores','onkeyup'=>'mayuscula(miembros_inferiores)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					            {{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('neurologico',$revision->neurologico,['id'=>'neurologico','class'=>'form-control','placeholder'=>'Neurologico','onkeyup'=>'mayuscula(neurologico)']) !!}
							</div>
							<div class="form-group col-sm-3 col-md-3">
					            {{-- <span class="form-group-addon">Revision General</span> --}}
								{!! Form::text('otros',$revision->otros,['id'=>'otros','class'=>'form-control','placeholder'=>'Otros Sist.','onkeyup'=>'mayuscula(otros)']) !!}
							</div>
						</div>
			...
			<div class="panel panel-default">
				<div class="panel-body">
					{!! Form::open(['id'=>'formEvaluacion']) !!}
						...
						<div class="form-group">
							{!! Form::hidden('id_evaluacion',$evaluacion->id_evaluacion_consulta,['id'=>'id_evaluacion','class'=>'form-control','placeholder'=>'idc']) !!}
						</div>
					{!! Form::close() !!}

					<!-- DIAGNOSTICOS -->
					<div class="col-sm-6 col-md-3">
						<h4><a href="#" data-toggle="modal" data-target="#ModalDiagnosticos" class="btn btn-info">+ Diagnosticos</a></h4>
					...
					<!-- ORDENES LAB -->
					<div class="col-sm-6 col-md-3">
						<h4><a href="#" data-toggle="modal" data-target="#ModalOrdenesL" class="btn btn-info">+ Orden Lab.</a></h4>
					...
					<!-- ORDENES GAB -->
					<div class="col-sm-6 col-md-3">
						<h4><a href="#" data-toggle="modal" data-target="#ModalOrdenesG" class="btn btn-info">+ Orden Gab.</a></h4>
					...
					<!-- MEDICAMENTOS -->
					<div class="col-sm-6 col-md-3">
						<h4><a href="#" data-toggle="modal" data-target="#ModalMedicamentos" class="btn btn-info">+ Tratamiento</a></h4>
