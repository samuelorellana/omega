...
<div class="panel panel-default marco_trabajo">
	...
	<div class="panel-heading">
		<div class="container-fluid">
			<h1>Edicion de Datos de Persona</h1>
		</div>
	</div>

	<div class="panel-body">
		<div class="container-fluid">
			{!! Form::model($persona,['route'=>['persona.update',$persona->id_persona],'method'=>'PUT','role'=>'form']) !!}
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							<div class="input-group">
								...
								{!! Form::input('date','fecha_nacimiento',null,['id'=>'fecha_nacimiento','class'=>'form-control','placeholder'=>'dd/mm/aaaa']) !!}
							</div>
						</div>
